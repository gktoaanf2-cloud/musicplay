...
(function() {
    ...
    window.addEventListener('load', async function() {
        ...
        if(tools){
            ...
            // 뷰어 바로가기
            var viewEl=document.createElement('button');
            viewEl.style.cssText='position:absolute;top:40px;left:140px;z-index:999999;background:transparent;border:none;color:rgba(255,255,255,0.35);font-size:11px;cursor:pointer;transition:0.3s;font-family:inherit;text-transform:uppercase;letter-spacing:2px;font-weight:600;';
            viewEl.textContent='👁 VIEW';
            viewEl.onmouseover=function(){this.style.color='var(--color-1)';};
            viewEl.onmouseout=function(){this.style.color='rgba(255,255,255,0.35)';};
            viewEl.onclick=function(){window.open(window.location.origin+window.location.pathname.replace(/\/[^\/]*$/,'/')+'viewer.html?id='+PL_ID,'_blank');};
            document.getElementById('export-target').appendChild(viewEl);
        ...
        uiStyle.textContent = '.control-btn svg{fill:var(--color-5)!important;}.play-pause-btn svg{fill:var(--color-5)!important;}.progress-fill{background:linear-gradient(90deg,var(--color-5),var(--color-3))!important;box-shadow:0 0 10px var(--color-5)!important;}.progress-fill::after{background:var(--color-5)!important;box-shadow:0 0 10px var(--color-5)!important;}.diamond-mark{background:var(--color-5)!important;}.track-item.playing{color:var(--color-5)!important;text-shadow:0 0 15px var(--color-5)!important;}.track-item.playing .diamond-mark{box-shadow:0 0 8px var(--color-5)!important;}.track-item.playing .diamond-mark::before{border-color:var(--color-5)!important;}.track-item:hover .diamond-mark{box-shadow:0 0 8px var(--color-5)!important;}.track-item.playing::after{content:""!important;position:absolute!important;bottom:0!important;left:0!important;width:100%!important;height:0.25px!important;background:linear-gradient(90deg,transparent 0%,var(--color-5) 50%,transparent 100%)!important;background-size:200% 100%!important;box-shadow:0 0 6px 0.5px var(--color-5)!important;animation:cyber-scan 2.5s cubic-bezier(0.4,0,0.2,1) infinite!important;opacity:0.8!important;transition:none!important;pointer-events:none!important;}.volume-wrapper svg{fill:var(--color-5)!important;}.volume-slider::-webkit-slider-thumb{background:var(--color-5)!important;box-shadow:0 0 10px var(--color-5)!important;}#current-track-name{color:var(--color-5)!important;}.wave-ring{border-color:var(--color-5)!important;}.lp-halo-ring{background:conic-gradient(from 0deg,var(--color-5),transparent 20%,var(--color-2) 40%,transparent 60%,var(--color-3) 80%,var(--color-5))!important;}';
